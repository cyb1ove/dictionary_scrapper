...
class Ee extends H {
  ...
  distributeViewSizes() {
    ...
    for (var _t6 of e) _t6.size = z(i, _t6.minimumSize, _t6.maximumSize);
  ...
  resize(e, t, i, n, r, s, o, a, u) {
    ...
    if (r) for (var _e9 of r) Y(h, _e9), Y(c, _e9);
    if (n) for (var _e10 of n) B(h, _e10), B(c, _e10);
  ...
  return u(I, () => ({
    reset: () => {
      if (b) b();else {
        ...
        for (var _e23 = 0; _e23 < $.current.length; _e23++) R(_e23);
      }
    },
    resize: e => {
      var _P$current3;

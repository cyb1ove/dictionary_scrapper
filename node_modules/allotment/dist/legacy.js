...
e = {
  ...
  function i() {
    for (var e = [], n = 0; n < arguments.length; n++) {
      ...
      if (s) {
        var r = _typeof(s);
        if ("string" === r || "number" === r) e.push(s);else if (Array.isArray(s)) {
          if (s.length) {
            var o = i.apply(null, s);
            o && e.push(o);
          }
        } else if ("object" === r) if (s.toString === Object.prototype.toString) for (var a in s) t.call(s, a) && s[a] && e.push(a);else e.push(s.toString());
      }
    }
    return e.join(" ");
  }
...
function l(e) {
  ...
  e = e.replace(s, "");
  var i = o.test(e);
  return i || a.test(e) ? u(e.slice(2), i ? 2 : 8) : r.test(e) ? NaN : +e;
}
...
!function (e, t) {
  var i = "__lodash_hash_undefined__",
    ...
    _ = /^(?:0|[1-9]\d*)$/,
    I = {};
  I["[object Float32Array]"] = I["[object Float64Array]"] = I["[object Int8Array]"] = I["[object Int16Array]"] = I["[object Int32Array]"] = I["[object Uint8Array]"] = I["[object Uint8ClampedArray]"] = I["[object Uint16Array]"] = I["[object Uint32Array]"] = !0, I[s] = I[r] = I[z] = I[o] = I[w] = I[a] = I[u] = I[c] = I[h] = I[l] = I[f] = I[p] = I[v] = I[y] = I[g] = !1;
  var x = "object" == _typeof(m) && m && m.Object === Object && m,
  ...
  function Ee(e, t, i, n, c) {
    return e === t || (null == e || null == t || !Be(e) && !Be(t) ? e != e && t != t : function (e, t, i, n, c, m) {
      var d = Re(e),
        g = Re(t),
        S = d ? r : Pe(e),
        _ = g ? r : Pe(t),
      ...
      if (E && !I) return m || (m = new we()), d || We(e) ? Le(e, t, i, n, c, m) : function (e, t, i, n, s, r, c) {
        switch (i) {
          case w:
  ...
  (se && Pe(new se(new ArrayBuffer(1))) != w || re && Pe(new re()) != h || oe && Pe(oe.resolve()) != d || ae && Pe(new ae()) != v || ue && Pe(new ue()) != g) && (Pe = function Pe(e) {
    var t = Ie(e),
  ...
  var h = t.useRef({
    ...
    l = function (e, i) {
      ...
      var o = t.useCallback(function () {
        ...
        n.current && n.current.element === o && n.current.subscriber === e || (n.current && n.current.cleanup && n.current.cleanup(), n.current = {
          element: o,
          subscriber: e,
      ...
      return r.current && r.current.box === e.box && r.current.round === s || (r.current = {
        box: e.box,
        round: s,
      ...
      }), r.current.instance.observe(t, {
        box: e.box
      }), function () {
        r.current && r.current.instance.unobserve(t);
      };
    }, [e.box, s]), e.ref);
...
var b = "allotment-module_splitView__L-yRc",
  ...
  I = "allotment-module_separatorBorder__x-rDS";
var x,
  E = !1,
  V = !1;
"object" == (typeof navigator === "undefined" ? "undefined" : _typeof(navigator)) && (x = navigator.userAgent, V = x.indexOf("Macintosh") >= 0, E = (x.indexOf("Macintosh") >= 0 || x.indexOf("iPad") >= 0 || x.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0);
var j = E,
  L = V,
...
function K(e) {
  ...
  e = e.replace(T, "");
  var i = R.test(e);
  return i || k.test(e) ? H(e.slice(2), i ? 2 : 8) : F.test(e) ? NaN : +e;
}
var Z = function Z(e, t, i) {
    ...
    return t = K(t) || 0, J(i) && (h = !!i.leading, r = (l = "maxWait" in i) ? G(K(i.maxWait) || 0, t) : r, f = "trailing" in i ? !!i.trailing : f), b.cancel = function () {
  ...
  ne = "sash-module_maximum__TCWxD",
  se = "sash-module_horizontal__kFbiw",
  re = "sash-module_hover__80W6I",
...
var le = /*#__PURE__*/function (_M) {
  ...
  function le(e, t, i) {
    ...
    _this = _super.call(this), _this.el = void 0, _this.layoutProvider = void 0, _this.orientation = void 0, _this.size = void 0, _this.hoverDelay = 300, _this.hoverDelayer = Z(function (e) {
      return e.classList.add("sash-hover", re);
      ...
      _this.el.classList.add("sash-active", oe), _this.emit("start", n), _this.el.setPointerCapture(e.pointerId);
      var s = function s(e) {
          e.preventDefault();
          var n = {
            startX: t,
        ...
        r = function r(e) {
          e.preventDefault(), _this.el.classList.remove("sash-active", oe), _this.hoverDelayer.cancel(), _this.emit("end"), _this.el.releasePointerCapture(e.pointerId), window.removeEventListener("pointermove", s), window.removeEventListener("pointerup", r);
        };
      window.addEventListener("pointermove", s), window.addEventListener("pointerup", r);
    }, _this.onPointerDoublePress = function () {
      _this.emit("reset");
    }, _this.onMouseEnter = function () {
      _this.el.classList.contains(oe) ? (_this.hoverDelayer.cancel(), _this.el.classList.add("sash-hover", re)) : _this.hoverDelayer(_this.el);
    }, _this.onMouseLeave = function () {
      _this.hoverDelayer.cancel(), _this.el.classList.remove("sash-hover", re);
    }, _this.el = document.createElement("div"), _this.el.classList.add("sash", q), _this.el.dataset.testid = "sash", e.append(_this.el), L && _this.el.classList.add("sash-mac", ee), _this.el.addEventListener("pointerdown", _this.onPointerStart), _this.el.addEventListener("dblclick", _this.onPointerDoublePress), _this.el.addEventListener("mouseenter", _this.onMouseEnter), _this.el.addEventListener("mouseleave", _this.onMouseLeave), "number" == typeof i.size ? (_this.size = i.size, i.orientation === ae.Vertical ? _this.el.style.width = "".concat(_this.size, "px") : _this.el.style.height = "".concat(_this.size, "px")) : (_this.size = ce, he.on("onDidChangeGlobalSize", function (e) {
...
var be = /*#__PURE__*/function (_M2) {
  ...
  _createClass(be, [{
    ...
    value: function addView(e, t, i) {
      ...
      var o = this.orientation === ae.Vertical ? new ye(e, t, r) : new ve(e, t, r);
      if (this.viewItems.splice(n, 0, o), this.viewItems.length > 1) {
        ...
        _e6.on("start", function (e) {
          ...
          var t = _this4.sashItems.findIndex(function (t) {
            ...
            i = C(t, -1, -1),
            n = C(t + 1, _this4.viewItems.length),
    ...
    value: function moveView(e, t, i) {
      var n = this.getViewCachedVisibleSize(t),
        s = void 0 === n ? this.getViewSize(t) : fe.Invisible(n),
        r = this.removeView(t);
    ...
    value: function layout() {
      ...
      if (this.size = e, this.proportions) for (var _t4 = 0; _t4 < this.viewItems.length; _t4++) {
        ...
        _i4.size = f(Math.round(this.proportions[_t4] * e), _i4.minimumSize, _i4.maximumSize);
      } else {
        var _i5 = C(0, this.viewItems.length),
          _n3 = _i5.filter(function (e) {
            return _this5.viewItems[e].priority === de.Low;
          }),
          _s3 = _i5.filter(function (e) {
            return _this5.viewItems[e].priority === de.High;
          });
    ...
    value: function resizeView(e, t) {
      ...
      var i = C(0, this.viewItems.length).filter(function (t) {
        ...
        n = [].concat(_toConsumableArray(i.filter(function (e) {
          return _this6.viewItems[e].priority === de.Low;
        })), [e]),
        s = i.filter(function (e) {
          return _this6.viewItems[e].priority === de.High;
        }),
        r = this.viewItems[e];
      t = Math.round(t), t = f(t, r.minimumSize, Math.min(r.maximumSize, this.size)), r.size = t, this.relayout(n, s);
    }
  }, {
    key: "resizeViews",
    value: function resizeViews(e) {
      for (var _t5 = 0; _t5 < e.length; _t5++) {
        ...
        var _n4 = e[_t5];
        _n4 = Math.round(_n4), _n4 = f(_n4, _i6.minimumSize, Math.min(_i6.maximumSize, this.size)), _i6.size = _n4;
      }
    ...
    value: function distributeViewSizes() {
      ...
      var n = C(0, this.viewItems.length),
        s = n.filter(function (e) {
          return _this7.viewItems[e].priority === de.Low;
        }),
        r = n.filter(function (e) {
          return _this7.viewItems[e].priority === de.High;
        });
      this.relayout(s, r);
    }
  }, {
    ...
    value: function resize(e, t) {
      ...
      for (var _e14 = 0, _i12 = t = f(t, z, w); _e14 < l.length; _e14++) {
        var _t9 = l[_e14],
          _n5 = f(m[_e14] + _i12, _t9.minimumSize, _t9.maximumSize);
        _i12 -= _n5 - m[_e14], _t9.size = _n5;
      }
      for (var _e15 = 0, _i13 = t; _e15 < d.length; _e15++) {
        var _t10 = d[_e15],
          _n6 = f(p[_e15] - _i13, _t10.minimumSize, _t10.maximumSize);
    ...
    value: function distributeEmptySpace(e) {
      ...
      var i = this.size - t;
      var n = C(this.viewItems.length - 1, -1, -1);
      "number" == typeof e && A(n, e);
      for (var _e16 = 0; 0 !== i && _e16 < n.length; _e16++) {
        var _t11 = this.viewItems[n[_e16]],
          _s4 = f(_t11.size + i, _t11.minimumSize, _t11.maximumSize);
    ...
    value: function updateSashEnablement() {
      ...
      for (var _e17 = 0; _e17 < this.sashItems.length; _e17++) {
        ...
        if (_a && _u) {
          var _i14 = C(_e17, -1, -1),
            _r2 = C(_e17 + 1, this.viewItems.length),
          ...
          _c && s[_e17] && (o > 0 || this.startSnappingEnabled) ? _n7.state = ue.Minimum : _h && t[_e17] && (o < this.contentSize || this.endSnappingEnabled) ? _n7.state = ue.Maximum : _n7.state = ue.Disabled;
        } else _n7.state = _a && !_u ? ue.Minimum : !_a && _u ? ue.Maximum : ue.Enabled;
      }
    }
  }, {
...
var Se = /*#__PURE__*/function () {
  function Se(e, t) {
    ...
    this.priority = (_t$priority = t.priority) !== null && _t$priority !== void 0 ? _t$priority : de.Normal, this.snap = "boolean" == typeof t.snap && t.snap;
  }
  _createClass(Se, [{
    key: "preferredSize",
    get: function get() {
...
var Ie = t.forwardRef(function (_ref3, s) {
  var e = _ref3.className,
    i = _ref3.children;
  return t.createElement("div", {
    ref: s,
    className: n("split-view-view", w, e)
  }, i);
});
Ie.displayName = "Allotment.Pane";
var xe = t.forwardRef(function (_ref4, w) {
  ...
  return t.useImperativeHandle(w, function () {
    return {
      reset: function reset() {
        if (m) m();else {
          var _L$current2;
          (_L$current2 = L.current) === null || _L$current2 === void 0 ? void 0 : _L$current2.distributeViewSizes();
          for (var _e24 = 0; _e24 < P.current.length; _e24++) F(_e24);
        }
      },
      resize: function resize(e) {
        var _L$current3;
        (_L$current3 = L.current) === null || _L$current3 === void 0 ? void 0 : _L$current3.resizeViews(e);
      }
    };
  }), N(function () {
    var e = !0;
    c && O.current.size !== c.length && (e = !1, console.warn("Expected ".concat(c.length, " children based on defaultSizes but found ").concat(O.current.size))), e && c && (E.current = T.map(function (e) {
      return e.key;
    }));
    var t = _objectSpread({
      ...
      descriptor: {
        ...
        views: c.map(function (e, t) {
          ...
          var i = V.current.get(E.current[t]),
            n = new Se(M.current, _objectSpread(_objectSpread({
              ...
              priority: (_i$priority = i === null || i === void 0 ? void 0 : i.priority) !== null && _i$priority !== void 0 ? _i$priority : de.Normal
    ...
    L.current = new be(x.current, t, f, v, g), L.current.on("sashDragStart", function () {
      var _x$current;
      (_x$current = x.current) === null || _x$current === void 0 ? void 0 : _x$current.classList.add("split-view-sash-dragging");
    }), L.current.on("sashDragEnd", function () {
      var _x$current2;
      (_x$current2 = x.current) === null || _x$current2 === void 0 ? void 0 : _x$current2.classList.remove("split-view-sash-dragging");
      ...
      if (d && L.current) {
        ...
        for (var _t19 = 0; _t19 < _e25.length; _t19++) {
          ...
          void 0 !== (_i15 === null || _i15 === void 0 ? void 0 : _i15.visible) && _i15.visible !== L.current.isViewVisible(_t19) && d(_t19, L.current.isViewVisible(_t19));
        }
      }
      ...
      if (m) m();else {
        ...
        if (F(e)) return;
        if (F(e + 1)) return;
        (_L$current4 = L.current) === null || _L$current4 === void 0 ? void 0 : _L$current4.distributeViewSizes();
      }
    });
    var i = L.current;
    return function () {
    ...
    if (A) {
      ...
      for (var _e27 = _o.length - 1; _e27 >= 0; _e27--) {
        var _L$current5;
        _o[_e27] && ((_L$current5 = L.current) !== null && _L$current5 !== void 0 && _L$current5.removeView(_e27), _t20.splice(_e27, 1), P.current.splice(_e27, 1));
      }
      ...
      try {
        var _loop3 = function _loop3() {
          ...
          var n = _step9.value;
          var i = V.current.get(n),
            o = new Se(M.current, _objectSpread(_objectSpread({
              element: document.createElement("div"),
              ...
              priority: (_i$priority2 = i === null || i === void 0 ? void 0 : i.priority) !== null && _i$priority2 !== void 0 ? _i$priority2 : de.Normal
            }, (i === null || i === void 0 ? void 0 : i.preferredSize) && {
              preferredSize: i === null || i === void 0 ? void 0 : i.preferredSize
            }), {}, {
              snap: (_i$snap2 = i === null || i === void 0 ? void 0 : i.snap) !== null && _i$snap2 !== void 0 ? _i$snap2 : h
            }));
          (_L$current9 = L.current) !== null && _L$current9 !== void 0 && _L$current9.addView(O.current.get(n), o, fe.Distribute, _e26.findIndex(function (e) {
            return e === n;
          })), _t20.splice(_e26.findIndex(function (e) {
            return e === n;
          }), 0, n), P.current.splice(_e26.findIndex(function (e) {
            return e === n;
          }), 0, o);
        };
      ...
      for (; !p(_e26, _t20);) {
        ...
        try {
          var _loop = function _loop() {
            ...
            if (e !== i) {
              var _L$current6;
              (_L$current6 = L.current) === null || _L$current6 === void 0 ? void 0 : _L$current6.moveView(O.current.get(n), e, i);
              var _s5 = _t20[e];
      ...
      var _loop2 = function _loop2() {
        ...
        i && _e(i) && void 0 !== i.visible && ((_L$current7 = L.current) === null || _L$current7 === void 0 ? void 0 : _L$current7.isViewVisible(n)) !== i.visible && ((_L$current8 = L.current) === null || _L$current8 === void 0 ? void 0 : _L$current8.setViewVisible(n, i.visible));
      };
      for (var _i17 = 0, _arr2 = [].concat(_toConsumableArray(_i16), _toConsumableArray(_n8)); _i17 < _arr2.length; _i17++) {
        _loop2();
      }
      var _iterator12 = _createForOfIteratorHelper(_n8),
        _step12;
      try {
        var _loop5 = function _loop5() {
          ...
          if (i && _e(i)) {
            ...
            var _e28 = !1;
            void 0 !== i.minSize && P.current[n].minimumSize !== i.minSize && (P.current[n].minimumSize = i.minSize, _e28 = !0), void 0 !== i.maxSize && P.current[n].maximumSize !== i.maxSize && (P.current[n].maximumSize = i.maxSize, _e28 = !0), _e28 && ((_L$current11 = L.current) === null || _L$current11 === void 0 ? void 0 : _L$current11.layout());
          }
        };
  ...
  }, [T, A, s, r, h]), t.useEffect(function () {
    L.current && (L.current.onDidChange = f);
  }, [f]), t.useEffect(function () {
    L.current && (L.current.onDidDragStart = v);
  }, [v]), t.useEffect(function () {
    L.current && (L.current.onDidDragEnd = g);
  }, [g]), y({
    ref: x,
    onResize: function onResize(_ref5) {
      ...
      var e = _ref5.width,
        t = _ref5.height;
      e && t && ((_L$current12 = L.current) !== null && _L$current12 !== void 0 && _L$current12.layout(l ? t : e), M.current.setSize(l ? t : e), C(!0));
    }
  }), N(function () {
    if (!A) {
      var _L$current13;
      var _x$current$getBoundin = x.current.getBoundingClientRect(),
        _e29 = _x$current$getBoundin.height,
        _t21 = _x$current$getBoundin.width;
      (_L$current13 = L.current) !== null && _L$current13 !== void 0 && _L$current13.layout(l ? _e29 : _t21), M.current.setSize(l ? _e29 : _t21), C(!0);
    }
  }, [A, l]), t.useEffect(function () {
    j && Ee(20);
  }, []), t.createElement("div", {
    ref: x,
    className: n("split-view", l ? "split-view-vertical" : "split-view-horizontal", {
      "split-view-separator-border": a
    }, b, l ? S : _, _defineProperty({}, I, a), i)
  }, t.createElement("div", {
    className: n("split-view-container", z)
...
exports.Allotment = Ve, exports.LayoutPriority = de, exports.setSashSize = Ee;
